    ...
    <AnimatePresence initial={false}>
      {content ? (
        <motion.div
          ...
          className={cn("overflow-hidden text-sm font-normal text-destructive", className)}
        >
          {content}
        </motion.div>
      ) : null}
