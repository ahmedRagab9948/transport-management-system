...
export const dashboardQueryKeys = {
  ...
  tripsStatus: [...DASHBOARD_ROOT, 'tripsStatus'] as const,
  monthlyTrips: [...DASHBOARD_ROOT, 'monthlyTrips'] as const,
  vehicleUtilization: [...DASHBOARD_ROOT, 'vehicleUtilization'] as const,
  driverStatus: [...DASHBOARD_ROOT, 'driverStatus'] as const,
  recentActivity: [...DASHBOARD_ROOT, 'recentActivity'] as const,
  systemAlerts: [...DASHBOARD_ROOT, 'systemAlerts'] as const,
};
